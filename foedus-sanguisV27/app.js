...
function pgUnit(){
  ...
  var infoH='<div style="background:rgba(201,162,39,.07);border:1px solid var(--golddim);border-radius:4px;padding:14px 18px;margin-bottom:20px;line-height:1.8">'
    ...
    +'<div><span style=\'color:var(--gold)\'>★☆☆☆☆ Unité possédée mais inutilisable (manque de niveau, doctrines...)</div>'
    +'<div><span style=\'color:var(--gold)\'>★★☆☆☆ Niveau expert mais unité inutilisable car doctrines enlevées (changement de méta ou autre)</div>'
    +'<div><span style=\'color:var(--gold)\'>★★★☆☆ J\'ai les bases je sais jouer l\'unité et mes doctrines sont en dessous du tier 3</div>'
    +'<div><span style=\'color:var(--gold)\'>★★★★☆ J\'ai les bases je sais jouer l\'unité et mes doctrines sont au tier 4 ou plus</div>'
    +'<div><span style=\'color:var(--gold)\'>★★★★★ Je connais tout sur l\'unité et la joue très bien (rôle, match up, passifs, actifs...), mes doctrines sont au tier 4 ou plus</div>'
    +'</div>'
