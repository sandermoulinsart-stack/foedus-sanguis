...
function pgUnit(){
  ...
  var infoH='<div style="background:rgba(201,162,39,.07);border:1px solid var(--golddim);border-radius:4px;padding:14px 18px;margin-bottom:20px;line-height:1.8">'
    ...
    +'<div>★★★☆☆ J\'ai les bases je sais jouer l\'unité et mes doctrines sont en dessous du tier 3</div>'
    +'<div>★★★★☆ J\'ai les bases je sais jouer l\'unité et mes doctrines sont au tier 4 ou plus</div>'
    +'<div>★★★★★ Je connais tout sur l\'unité et la joue très bien (rôle, match up, passifs, actifs...), mes doctrines sont au tier 4 ou plus</div>'
    +'</div>'
