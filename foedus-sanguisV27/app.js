...
function pgUnit(){
  ...
  var infoH='<div style="background:rgba(201,162,39,.07);border:1px solid var(--golddim);border-radius:4px;padding:14px 18px;margin-bottom:20px;line-height:1.8">'
    ...
    +'<div>★☆☆☆☆ Possédée, peu ou jamais jouée</div>'
    +'<div>★★☆☆☆ Jouée occasionnellement, en apprentissage</div>'
    +'<div>★★★☆☆ Maîtrisée, jouée régulièrement</div>'
    +'<div>★★★★☆ Très à l\'aise, unité de confiance</div>'
    +'<div>★★★★★ Doctrinée, maîtrise totale, ta signature</div>'
    +'</div>'
