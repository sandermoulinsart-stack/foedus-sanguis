...
function pgUnit(){
  ...
  var infoH='<div style="background:rgba(201,162,39,.07);border:1px solid var(--golddim);border-radius:4px;padding:14px 18px;margin-bottom:20px;line-height:1.8">'
    ...
    +'<div>★★☆☆☆ Niveau expert mais inutilisable — doctrines enlevées (changement de méta ou autre)</div>'
    +'<div>★★★☆☆ Je sais jouer l\'unité, doctrines en dessous du tier 3 — <strong style="color:var(--tx1)">50% impactant</strong></div>'
    +'<div>★★★★☆ Je sais jouer l\'unité, doctrines au tier 4 ou plus — <strong style="color:var(--tx1)">70% impactant</strong></div>'
    +'<div>★★★★★ Je connais tout sur l\'unité, la joue très bien (rôle, match-up, passifs, actifs...), doctrines tier 4+ — <strong style="color:#66bb6a">impact garanti</strong></div>'
    +'</div>'
